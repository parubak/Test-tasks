...
<div class="container d-flex flex-column mt-2">
    <div class="text-right">
        <div class="col ">
            ...
            echo $id ?>"><input type="button" name="beak" class="btn btn-outline-dark w-25 mr-5" value="Back"/></a>
        </div>
    </div>
...
<div class="container d-flex  justify-content-sm-center">
    <form name="edit" id="frmEdit" action="edit"  method="POST" class="d-flex flex-column justify-content-sm-center"
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                     ...
                     <input type="date" id="inputDate" name="inputDate" class="form-control text-center pl-4"
                            placeholder="y-M-d" <?php echo "min='". $nowDate ."' value='". $CONTENT[0]["data"] ."'";?>
                            required/>
            ...
            <div class="form-group col-xl-10">
                ...
                <div class="">
                    <div class="w-100 p-3 d-flex justify-content-center text-center">
                            ...
                            <input type="button" value="Delete" onclick="onclickDelete(<?php echo $id ?>)"
...
key=AIzaSyAgFxVevJK-v3gWt49uyDpB91g8g1IMVrQ&callback&libraries=places&callback=initMap&solution_channel=
